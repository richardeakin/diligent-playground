...
{
    return new InstancedCubes();
}

void InstancedCubes::CreatePipelineState()
{
...
void InstancedCubes::CreateInstanceBuffer()
{
...
void InstancedCubes::PopulateInstanceBuffer()
{
...
void InstancedCubes::LoadTextures()
{
...
void InstancedCubes::Initialize(const SampleInitInfo& InitInfo)
{
...
void InstancedCubes::Update(double CurrTime, double ElapsedTime)
{
